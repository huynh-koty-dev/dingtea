...
<head>
  ...
  <title>CraloyAdmin | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Craloy</b> Admin</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="adlogin.php" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="adsubmit">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
