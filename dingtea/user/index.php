...
<title>Member - <?php echo $_SESSION["ten_tv"]; ?></title>
<style>
	.active{
    ...
    <div class="col-lg-2 col-md-3 col-sm-12">
      ...
      <div class="w3-sand">
        <div class="w3-container">
         ...
         <p class="w3-center"><img src="../core_images/ava.png" class="w3-circle" style="height:70px;width:70px" alt="Avatar"></p>
			 <h4 class="w3-center"><?php echo $_SESSION["ten_tv"];?></h4>
         <hr>
         <?php
