...
<div class="w3-row-padding w3-content" style="max-width:1400px">
  <div class="w3-twothird w3-center">
   ...
   <h1 class="w3-xxxlarge w3-text-brown"><b><?php echo $new->tieu_de; ?></b></h1>
    ...
    <div class="w3">
      <img src="images/gcs_thumb_5768a93f6e0b496d85b65740-2016-06-21-024110.jpg" style="width:100%" onclick="onClick(this)">
  ...
  <div class="w3-third">
	...
	<img src="images/gcs_thumb_57f5c2216e0b494c1926a1bf-2016-10-06-031651.jpg" width = "50%"; >
		</div>
		<br>
      <p class="w3-justify">Được giảm giá và nhiều ưu đãi khác đang chờ bạn!
			</p>
    </div>
	  <br>
	      <div class="w3-container  w3-light-grey w3-justify">
      <h4 class=" w3-text-red w3-center" style="text-shadow:1px 1px 0 #444"> Cách săn khuyến mại </h3>
		<div class="w3-container w3-center">
	<img src="images/gcs_thumb_57f5c2206e0b494c1c2638a9-2016-10-06-031651.jpg" width = "50%"; >
		</div>
		<br>
      <p class="w3-justify">Đăng nhập theo giờ bạn sẽ có cơ hội nhận được những phần quà hấp dẫn!
		  <br>
			</p>
    </div>
